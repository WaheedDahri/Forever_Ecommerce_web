...
//   const [cartItems, setCartItems] = useState([]); // object of objects
...
//   // 🔹 Load token & fetch cart on app start
//   useEffect(() => {
...
//       size,
//       quantity,
//       price: products.find((p) => p.id === productId || p._id === productId)?.price || 0,
//     }))
//   );
...
//         setCartItems,
//         cartItems,
//         cartItemsArray, // ✅ for PlaceOrder.jsx
//         addToCartBackend,
//         updateCartBackend,
